...
def testKillerWin():
	#GUI for terminating in progress test
...
def testKiller(event):
	#sets a flag shared by processes to trigger early termination before resetting the flag
	event.set()
	time.sleep(3)
	event.clear
...
def exampleOpener():
	...
	file = r"\\EBSNAS\share\EManS\ThermoReader-master\Example_Output.xlsx"
	os.startfile(file)
	return

def readmeOpener():
	#Opens the Readme for User Instruction and Information
	file = r"\\EBSNAS\share\EManS\ThermoReader-master\readme.md"
	os.startfile(file)
	return
...
def refresh():
	...
	#print("REFRESHING!")  #only used in testing
...
#Main Window
	...
	'''
	image0 = tkinter.PhotoImage(file=r"\\EBSNAS\share\EManS\ThermoReader-master\ready.png")
	image1 = tkinter.PhotoImage(file=r"\\EBSNAS\share\EManS\ThermoReader-master\test_run.png")
	image2 = tkinter.PhotoImage(file=r"\\EBSNAS\share\EManS\ThermoReader-master\temp_met.png")
	image3 = tkinter.PhotoImage(file=r"\\EBSNAS\share\EManS\ThermoReader-master\probe_er.png")
